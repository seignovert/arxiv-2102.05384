...
\caption{\change{Top-left: The annual variations of the zonally averaged equatorial opacity at 700 nm extracted from \cite{Lebonnois2012} and wrapped around $L_s = \ang{0}$.
Top-right: the seasonal evolution of the aerosol mass density (g/cm$^3$) adapted from \cite{Larson2015} (right).
Middle: The haze extinction as a function of time and altitude at the equator (this work).
...
Bottom: Same result as middle but linearly extrapolated in area without observations. This plot is only provided as an indicative global pattern but contains obvious interpolation artefact.}
