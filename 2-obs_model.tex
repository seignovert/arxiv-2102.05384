...
\caption{\change{Timeline of the ISS/NAC CL1-UV3 images analyzed (vertical black ticks). The number of observations per 2 Earth months period (\ie 4 Titan days / $\Delta Ls \approx \ang{2}$) is reported with a green gradient scale.}}
