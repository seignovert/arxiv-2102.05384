...
The uncertainties in the extinction profile ($\beta$) correspond to the minimum and maximum values required to fit the data within $1 \sigma$ of the observed $I/F$.}
